      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <h2 className="mt-2 text-2xl font-bold tracking-tight text-white">
            OpsIntel Commercial Launch Ready
          </h2>

          <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-400">
            OpsIntel is now positioned for executive demonstrations,
            consulting engagements, SaaS commercialization, white-label
            licensing, and enterprise customer adoption.
          </p>
        </div>

        <div className="grid grid-cols-2 gap-3 text-xs md:grid-cols-4">
          {["SaaS", "Consulting", "White-Label", "Enterprise"].map(
            (item) => (
              <div
                key={item}
