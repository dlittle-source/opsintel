      ...
      <div className="relative z-10 grid gap-6 lg:grid-cols-[1.2fr_1fr] lg:items-center">
        <div>
          ...
          <h2 className="mt-4 text-2xl font-semibold tracking-tight text-white">
            Enterprise AI Operations Platform Ready
          </h2>

          <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-400">
            Architecture generation, deployment intelligence, governance,
            optimization, multicloud strategy, and AI-assisted decision support
            are unified into one executive operating experience.
          </p>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
            ...
            <p className="mt-1 text-xs leading-5 text-slate-400">
              Insights and readiness scoring.
            </p>
          </div>
